    ...
    <div className="space-y-4">
      ...
      <section className="overflow-hidden rounded-xl border border-border bg-surface">
        <div className="border-b border-line px-4 py-2">
          <Label htmlFor="defaults-tone" className="text-sm font-semibold">
            口氣
          </Label>
        </div>
        <div className="p-4">
      ...
      <section className="overflow-hidden rounded-xl border border-border bg-surface">
        <div className="border-b border-line px-4 py-2">
          <Label htmlFor="defaults-persona" className="text-sm font-semibold">
            Persona
          </Label>
        </div>
      ...
      <section className="overflow-hidden rounded-xl border border-border bg-surface">
        <div className="border-b border-line px-4 py-2">
          <Label htmlFor="defaults-custom-prompt" className="text-sm font-semibold">
            自訂提示
          </Label>
        </div>
        <div className="p-4">
          ...
          <Textarea
            ...
            rows={3}
            maxLength={2000}
            className="min-h-16 max-w-md text-xs mt-2"
      ...
      <section className="overflow-hidden rounded-xl border border-border bg-surface">
        <div className="border-b border-line px-4 py-2">
          <span className="text-sm font-semibold">Sepia 潤稿</span>
        </div>
